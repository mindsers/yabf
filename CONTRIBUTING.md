# How to contribute to Yabf

*First off, thanks for taking the time to contribute!*

This file is a set of guilines for contributing to *Yabf* project. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
* [Do you want to contribute to the Yabf documentation?](#do-you-want-to-contribute-to-the-yabf-documentation)
...
* If you're unable to find an open issue addressing the problem, [open a new one](https://github.com/Mindsers/yabf/issues/new). Be sure to include a **title and clear description**, as much relevant information as possible, and a **code sample** or an **executable test case** demonstrating the expected behavior that is not occurring.
...
* Ask any question about how to use Yabf on [Stack Overflow](https://stackoverflow.com).

### Do you want to contribute to the Yabf documentation?
...
All JavaScript must adhere to [JavaScript Standard Style][Styleguide].
...
All TypeScript code must be as close as possilbe to JavaScript code. So, the rules follow the [JavaScript Standard Style][Styleguide] too plus some rules that only apply to TypeScript.

All the rules are listed in `tslint.json` on the root directory.
...
[Issues]: https://github.com/Mindsers/yabf/issues
